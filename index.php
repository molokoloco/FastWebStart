...
<div id="SearchBot">
	...
	<div class="blockRow" id="searhTerms">&nbsp;</div>
...
<div id="prefs" style="display:none;">
	...
	<ul><li><a href="javascript:void(0);" onClick="toggleFoxy();" id="toggleFoxy">Afficher/Masquer</a> &quot;Foxy&quot; (la chose qui bouge en haut ;)</li><li><a href="javascript:void(0);" onClick="toggleStock();" id="toggleStock">Retenir/Oublier</a> vos recherches</li></ul>
	<h3>Th&egrave;mes :</h3>
	<ul><li><a href="javascript:void(0);" rel="<?=$WWW;?>css/styles.css" class="css">Original</a></li><li><a href="javascript:void(0);" rel="<?=$WWW;?>css/style_light.css" class="css">Claire</a></li><li><a href="javascript:void(0);" rel="<?=$WWW;?>css/style_dark.css" class="css">Sombre</a></li></ul>
	<h3>Image de fond :</h3>
