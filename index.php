...
if ($action == 'update') { // Call by Ajax -> ./js/jquery.edit.js
	...
	$_SESSION['user']['SITES'] = trim(stripslashes($_POST['SITES'])); // Session backup, cf. ./js/sitesDatas.js.php
...
<head>
	...
	<script type="text/javascript" src="<?=$WWW;?>js/jquery.mlklc.js"></script>
</head>
<body>
<div id="info" style="display:none;">
	<h3>Welcome :)</h3>
	<p>Bienvenue sur GoogleBot !<br />
	Le portail synthétisé des services Google et des sites chouettes, utiles, et ceux qu'on oublie (à tord)...</p>
	<ul>
		<li><strong>Suggestion améliorée</strong> pendant votre recherche : <strong>Google</strong> pour compl&eacute;ter et<strong> Very Related</strong> pour assembler</li>
		...
		<li>C'est aussi une page de d&eacute;marrage qui s'affiche instantanément</li>
	</ul>
	<h3>Astuces...</h3>
	<ul>
		...
		<li>Une Question, un commentaire, une idée... <a href="http://b2bweb.uservoice.com/forums/35888" target="_blank" title="Laisser un commentaire, une idée... c'est par ici"><strong>c'est par ici !</strong></a></li>
	</ul>
	<p>Bon surf !</p>
	<p class="right"><a href="javascript:void(0);" onclick="$('div#info').fadeOut();">Fermer</a></p>
</div>
<div id="header">
	<div class="right"><span id="editmode"></span><a href="#prefs" onclick="$('div#prefs').fadeIn();" id="preferences" title="Changer le style de la page">Pr&eacute;f&eacute;rences</a> | <a href="#info" onclick="$('div#info').fadeIn();" title="Quelques explications sur les fonctionnalit&eacute;s de cette page" id="aide">Aide</a></div><div style="vertical-align:bottom;" id="menu">&nbsp;<a href="http://home.b2bweb.fr" onclick="return setDatas('home');" title="GoogleBot is Fast Web Start" class="bold" id="home">GoogleBot</a> | <a href="http://home.b2bweb.fr#code" onclick="return setDatas('code');" title="CodeBot is Fast Coding Tools : http://code.b2bweb.fr" id="code">CodeBot</a> | <a href="http://home.b2bweb.fr#twitter" onclick="return setDatas('twitter');" title="TwitterBot is Twitter Web Start : http://twitter.b2bweb.fr" id="twitter">TwitterBot</a><!-- | <a href="http://proxy.b2bweb.fr" title="Surf anonymously... (WorkInProgress)" id="proxy">ProxyBot</a>--></div>
</div>
<div id="footerBg">&nbsp;</div>
<div id="footer"><p>By <a href="http://www.b2bweb.fr" title="Aller sur http://www.b2bweb.fr">B2bweb.fr</a> | <a href="http://b2bweb.uservoice.com/forums/35888" target="_blank" title="Laisser une question, un commentaire, une idée... (avec uservoice.com)">FAQ</a> | <a href="http://www.google.com" title="Google suggest API">Google</a> &amp; <a href="http://www.veryrelated.com/" title="VeryRelated Mind Maps API">VeryRelated</a> | <a href="http://www.addthis.com/bookmark.php?v=250&amp;username=molokoloco" title="Bookmark and Share with AddThis">Partager</a> | <span id="heure" title="Time is runnnnning..." style="cursor:wait;">00:00:00</span></p></div>
...
<div id="prefs" style="display:none;">
	...
	<h3>Th&egrave;mes :</h3>
	<ul>
		<li><a href="javascript:void(0);" rel="<?=$WWW;?>css/styles.css" class="css">Original</a></li>
		<li><a href="javascript:void(0);" rel="<?=$WWW;?>css/style_light.css" class="css">Claire</a></li>
		<li><a href="javascript:void(0);" rel="<?=$WWW;?>css/style_dark.css" class="css">Sombre</a></li>
	</ul>
	<h3>Image de fond :</h3>
	<ul>
		<li>&lt;input type="upload" value="TODO" /&gt;</li>
	</ul>
	<h3>G&eacute;n&eacute;ral :</h3>
	<ul>
		<li><a href="javascript:void(0);" onclick="toggleFoxy();">Afficher/Masquer</a> &quot;Foxy&quot; (la chose qui bouge en haut ;)</li>
	</ul>
</div>
<div id="foxy">&nbsp;</div>
</body>
