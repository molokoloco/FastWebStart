...
// All code on GitHub : https://github.com/molokoloco/FastWebStart/ Take it, smash it ;)
-->
<!DOCTYPE html>
...
<body>
	...
	<div id="info" style="display:none;">
		<h3>Welcome :)</h3>
		<p>Bienvenue sur GoogleBot ! Le portail synth&eacute;tique des services Google et des sites chouettes, utiles, et ceux qu'on oublie (à tord)... C'est une page de d&eacute;marrage qui s'affiche instantan&eacute;ment</p>	
		<h3>B2bweb anonymous Google search</h3>
		<p>Un hack des DNS de google permet &agrave; <a href="http://google.b2bweb.fr/search?hl=fr&amp;q=anonyme" target="_blank">google.b2bweb.fr</a> de rediriger vos requ&ecirc;tes vers Google, sans que celui ne puisse vous reconnaitre : votre IP devient celle du serveur (in CNAME : explications <a href="http://goo.gl/naLqL" target="_blank">http://goo.gl/naLqL</a>). Pas de pub, pas d'historique, pas de connexion : Google light ! ;)</p>
		<ul>
			<li><strong>Touche clavier</strong> pour trouver les sites commen&ccedil;ants par cette lettre</li>
			<li>Si vous saisissez une recherche, cliquer sur un lien ouvre la page de r&eacute;sultats sur le site</li>
			...
			<li>Op&eacute;rateurs &quot;<strong>, + - AND</strong>&quot; pour ajouter une suggestion (Google)</li>
			...
			<li>Le<strong> mode &eacute;dition</strong> ne sauvegarde vos modifications sur les sites que si vous êtes connect&eacute; <s>(Pour le moment via Facebook)</s></li>
			...
			<li>Les recherches, la <strong>personnalisation du th&egrave;me</strong>, ... reste simplement stock&eacute; dans un cookie (Personnel)</li>
			<li><strong>Aucune donn&eacute;e personnelle sur le serveur !</strong> (Stockage dans vos cookies)</li>
		</ul>
		<p>Le code source est <a href="view-source:<?=$WWW;?>index.php" target="_blank" title="Let's go to the code ^^"><strong>ici</strong></a> et <a href="https://github.com/molokoloco/FastWebStart/" target="_blank" title="Let's go to the repository ^^"><strong>ici</strong></a> (Open source)<br />
		Une Question, un commentaire, une id&eacute;e... <a href="http://b2bweb.uservoice.com/forums/35888" target="_blank" title="Laisser un commentaire, une idée... c'est par ici"><strong>c'est par ici !</strong></a></p>
		<p>Bon surf !</p>
	...
	<div id="foxy">&nbsp;</div>
	<a href="https://github.com/molokoloco/FastWebStart/" title="See source code on GITHUB..." target="_blank" id="git">FastWEbStart on Github</a>
	<div id="footerBg">&nbsp;</div>
	<div id="footer">
