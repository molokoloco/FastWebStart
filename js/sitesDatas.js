...
{href:'http://www.tineye.com', result:'', tips:'Reverse Image Search', title:'TinEye'},
...
{href:'http://www.lequipe.fr', result:'http://www.lequipe.fr/recherche/search.php?r={R}', tips:'Toute l\'actualité sportive en direct', title:'L\'Equipe'},
...
{href:'http://www.telerama.fr', result:'http://recherche.telerama.fr/recherche/recherche.php?ecrivez={R}', tips:'L\'actualité culturelle en continu et toutes les critiques cinéma, télévision, programme télé, livres', title:'Télérama'},
...
{href:'http://culturebox.france3.fr/', result:'http://culturebox.france3.fr/#/{R}', tips:'L\'info culturelle en vidéo - France Télévisions', title:'Culturebox'},
{href:'http://www.arte.tv', result:'http://www.arte.tv/fr/recherche/1383954,templateId=noncache.html?doSearch=true&keyword={R}', tips:'Site de la chaine Arte', title:'<strong>ArteTV</strong>'},
...
{href:'http://proxy.org', result:'', tips:'Surfer\'s guide to online privacy and anonymous web surfing', title:'Proxy'},
{href:'http://hidemyass.com/', result:'', tips:'Free Proxy and Privacy Tools - Surf The Web Anonymously', title:'<strong>HideMyAss</strong>'},
{href:'http://google.b2bweb.fr', result:'', tips:'Proxy de recherche anonyme', title:'Anonyme'},
